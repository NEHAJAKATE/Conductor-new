...
export class JsonConnector implements ConnectorPlugin {
  readonly type = 'json' as const;
  readonly displayName = 'JSON Collection';
  readonly description = 'Connector for ingesting structured JSON lists and document objects.';
