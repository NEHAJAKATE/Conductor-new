...
exports.default = InteractiveWorkflow;
const jsx_runtime_1 = require("react/jsx-runtime");
const react_1 = require("react");
const react_2 = require("@xyflow/react");
require("@xyflow/react/dist/style.css");
const FlowNodes_1 = require("./FlowNodes");
const nodeTypes = {
    hexNode: FlowNodes_1.HexNode,
    groupNode: FlowNodes_1.GroupNode,
};
...
function InteractiveWorkflow() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: { width: '100%', height: '100%', minHeight: 'calc(100vh - 120px)', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--grid-line-major)', position: 'relative' }, children: [(0, jsx_runtime_1.jsx)("div", { className: "studio-grid" }), (0, jsx_runtime_1.jsx)(react_2.ReactFlow, { nodes: nodes, edges: edges, onNodesChange: onNodesChange, onEdgesChange: onEdgesChange, onConnect: onConnect, nodeTypes: nodeTypes, fitView: true, minZoom: 0.2, proOptions: { hideAttribution: true }, children: (0, jsx_runtime_1.jsx)(react_2.Controls, { style: { backgroundColor: 'var(--bg-surface)', border: '1px solid var(--grid-line-major)', fill: 'var(--text-loud)', zIndex: 10 } }) })] }));
}
