...
const canonical_mapping_service_1 = require("../mapping/canonical-mapping.service");
class TransformationService {
    async transform(records, schema) {
            ...
            for (const [key, value] of Object.entries(record)) {
                ...
                if (typeof cleanVal === 'string') {
                    ...
                    if (key.toLowerCase().includes('date') || key.toLowerCase().includes('time') || key === 'C_DATE') {
                        cleanVal = canonical_mapping_service_1.CanonicalMappingService.parseDate(cleanVal);
                    }
                }
